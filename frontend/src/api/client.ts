...
export const api = {
  ...
  getDeepseekRoute: () => request<ProviderRoute>('/api/admin/provider-routes/deepseek'),
  listDeepseekRouteOptions: () => request<ProviderRouteOption[]>('/api/admin/provider-routes/deepseek/options'),
  saveDeepseekRoute: (route: string) =>
    request<ProviderRoute>('/api/admin/provider-routes/deepseek', {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
