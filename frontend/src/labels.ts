...
const TOOL_LABELS: Record<string, string> = {
  ...
  login_probe: '弱口令与万能密码探测',
  sqlmap_probe: 'sqlmap 注入探测',
...
const TOOL_PURPOSES: Record<string, string> = {
  ...
  login_probe: '对授权登录页面进行小规模常规弱口令和万能密码探测；这是高风险表单提交动作，必须经过人工确认，结果会写入证据账本供 AI 复核。',
  sqlmap_probe: '调用原版 sqlmap 外部工具，对授权目标进行 SQL 注入探测；这是高风险验证动作，必须经过人工确认，结果会写入证据账本供 AI 复核和报告引用。',
